			...
			<div class="row">
				<div class="col-md-6 no-padding" style="width: 100%">
					<article class="item wp5">
						...
						<div class="form-signin" id="step4" style="display: none;background-color: black;color: white">
							First Name<input  type="text" class="form-control" name="firstname"
								required="" autofocus=""></input> <br><br> Last Name<input
								type="text" class="form-control" name="lastname" required=""
								autofocus=""></input> <br><br> E-mail<input type="text"
								id="user" class="form-control" name="username"
								placeholder="Email Address" required="" autofocus="" /> <br><br>
