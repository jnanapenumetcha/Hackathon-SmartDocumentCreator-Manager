				...
				<div class="primary-nav-wrapper">
					...
					<div class="secondary-nav-wrapper">
						<ul class="secondary-nav">
							<li class="subscribe"><a href="<%=request.getContextPath() %>/pages/signup.jsp" target="_blank">Logout</a></li>
...
<footer class="has-padding footer-bg" style="padding: 1% 0;">
	...
	<section class="freebies" id="getStarted">
		...
		<div class="container freebies-intro" style="padding-top: 2%;margin-bottom:30px;">
			<div class="row">
				<div class="col-md-12">
					<h4 style="margin: 7px 0 30px 60px">Documents</h4>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 no-padding" style="width: 100%">
					<article class="item wp5">
						<div id="step1" style="padding-top: 10%;padding-bottom: 10%; text-align: center;" >
							
							<s:iterator value="userdocuments">
							
							 <a href="https://www.dropbox.com/sh/qg7rfxsjwg9hyii/AAA2TBJ1EExm4Z91p4DkYF71a?dl=0&preview=<s:property/>"><s:property/></a> <br><br>
							</s:iterator>
						</div>
						</article>
						</div>
